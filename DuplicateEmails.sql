...
Since the email is already grouped (and DISTINCT isn't needed), each duplicate email is printed only once, because the GROUP BY eliminatesmultiple # occurrences of the same email in the result.
*/
